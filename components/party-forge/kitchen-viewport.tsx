...
import { KitchenHud } from './kitchen-hud.tsx';
...
type Props = Omit<ReturnType<typeof useTrialController>, 'view'> & { view: Omit<ReturnType<typeof useTrialController>['view'], 'snapshot'> & { snapshot: KitchenPartySnapshot | null } };
export function KitchenViewport({ controller, view }: Props) {
